...
- 導入済み: Next.js 16.2.4 / React 19 / Tailwind v4 / Prisma 7 (driver adapter: `@prisma/adapter-pg`) / zod / Monaco Editor / biome / swr / next-safe-action / supabase (`@supabase/ssr` + `@supabase/supabase-js`) / shadcn/ui / server-only / lucide-react

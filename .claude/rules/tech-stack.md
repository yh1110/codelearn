...
- 導入済み: Next.js 16.2.4 / React 19 / Tailwind v4 / Prisma 7 (driver adapter: `@prisma/adapter-pg`) / zod / Monaco Editor / biome
- 未導入: zustand / swr / next-safe-actions / supabase / shadcn/ui / playwright / vitest / nuqs / server-only / react-hook-form / @hookform/resolvers / lucide-react
